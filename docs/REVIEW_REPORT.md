...
#### 2. 画像アップロード機能の未実装
- **場所**: `lib/presentation/screens/product_registration_screen.dart`
- **内容**: 商品登録画面で画像選択UIは存在するが、アップロード処理が未実装
- **影響**: ユーザーが独自の商品画像を登録できない
...
| # | 改善案 | 効果 | 工数 |
|---|--------|------|------|
| 1 | **画像アップロード完成** | 商品登録の完全化 | 小 |
| 2 | **投稿編集・削除** | UGCの品質管理 | 小 |
| 3 | **オフラインモード** | 圏外のゲーセンでも使える | 中 |
| 4 | **全文検索改善** | 大規模データ対応 | 中 |
